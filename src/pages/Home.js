    ...
    return data?.slice(0, 10).map(i => {
      return (
        <TouchableOpacity
          ...
          <Image
            source={{uri: i.propertyImage?.image?.url}}
          ...
          <View className="p-5">
            ...
            <Text className="text-[#405189] text-2xl font-bold">
              {i.price?.lead?.formatted}
            </Text>
        ...
        <View className="px-8 pt-8 pb-20">
          ...
          <View className="bg-neutral-50 p-8 rounded-lg mb-5 relative">
            ...
            <View className="relative my-3">
              ...
              />
              <Image
                source={require('../assets/UserOutline.png')}
                className="w-6 h-6 relative bottom-10 left-3"
              />
            </View>
            {/* end input guest */}
                      ...
                      <TouchableOpacity
                        ...
                        <View className="snap-center">
                          <ImageBackground
                            ...
                            className="mr-3 w-44 h-40"
                            imageStyle={{borderRadius: 10}}>
                            <Text
                              className="text-xl text-white font-semibold absolute bottom-3 px-3"
                              numberOfLines={2}>
                              {hotel.name}
                            </Text>
                          </ImageBackground>
